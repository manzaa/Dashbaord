...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
			...
			<img alt="Mindtree | Welcome to possible" src="<?php echo $this->config->base_url(); ?>application/views/assets/img/mindtree-welcome-to-possible-logo.png" class="navbar-brand" style="width: 182px; height: 91px;   margin-top: -15px; margin-bottom: -15px;"/>
			   <a class="navbar-brand" style="margin-left:0px;" href="<?php echo $this->config->base_url(); ?>index.php/home">Dashboard</a>				
            </div>
			<?php		
			error_reporting(1);
